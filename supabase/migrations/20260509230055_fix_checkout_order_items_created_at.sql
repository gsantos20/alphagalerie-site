-- Migration: Fix checkout order item insert for missing created_at column
-- Description: Recreates create_order_with_items without inserting pedido_itens.created_at
-- Date: 2026-05-09
