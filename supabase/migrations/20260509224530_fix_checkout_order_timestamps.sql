-- Migration: Fix checkout order insert for pedidos timestamp column mismatch
-- Description: Recreates create_order_with_items without hardcoded pedidos timestamp columns
-- Date: 2026-05-09
